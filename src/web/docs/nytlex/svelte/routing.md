...
```
/src/web/[[lang]]/about/page.svelte → /:lang?/about
```
...
```
/src/web/docs/[...slug]/page.svelte → /docs/*
```
...
```
/src/web/[[...path]]/page.svelte → /* (also matches /)
```
