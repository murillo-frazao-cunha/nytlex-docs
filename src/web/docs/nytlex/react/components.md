...
The Link component enables fast client-side navigation between pages, using the Nytlex.js router. It is imported from `nytlex/react`.
...
The NytlexImage component (exported as `Image` or `NytlexImage` from `nytlex/react`) automatically optimizes images, reducing layout shift and improving performance. It is recommended for all images in your app.
